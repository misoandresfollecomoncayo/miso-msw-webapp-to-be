<?php
    ...
    $layout = new Layout();
    $layout->setTitle("Crear usuario sistema");
    $layout->printHead();
?>
    <body>
        <?php $layout->printMainBar(); ?>
        <div class="float-left canvas-width height-100 background-color-light-gray mobile-width-100">
            <?php $layout->printSessionBar("Crear usuario sistema", PUBLIC_PATH_PLATFORM . "SystemUsers/"); ?>
            <div id="frmUser" class="padding-top-5x padding-bottom-5x padding-left-7x padding-right-7x mobile-padding-3x canvas-height overflow-auto">
                <div class="width-100 padding-4x background-color-white border-radius box-shadow margin-top-3x">
                    ...
                    <div class="display-table padding-top-3x padding-bottom-3x width-100">
                        ...
                        <div class="float-left width-75"><input class="input-text-underline" type="password" data-required="true" data-name="Clave" id="txtPassword" /></div>
                    </div>
                    <!-- Role -->
                    <div class="display-table padding-top-3x padding-bottom-3x width-100">
        ...
        <script type="text/javascript">
            $("#btnSave").on("click", function(e) {
                ...
                if (frmUser.validate()) {
                    $.ajax({
                        url: URL_API + "SystemUser/Create.php",
                        type: "POST",
                        data: {
                            Names: $("#txtNames").val(),
                            Email: $("#txtEmail").val(),

        ...
        <div class="width-60 float-left background-color-white padding-5x border-radius box-shadow" id="frmNewCustomer">
            ...
            <div>
                <div class="display-table padding-top-3x padding-bottom-3x width-100">
                    <div class="width-100 text-align-center text-size-m text-weight-bold"><?php echo Internationalization::accountSuccessfullyActivatedLabel(); ?></div>
                    <div class="width-100 margin-top-4x text-align-center"><?php echo Internationalization::accountSuccessfullyActivatedBodyLabel(); ?></div>
                </div>
                <!-- Actions -->

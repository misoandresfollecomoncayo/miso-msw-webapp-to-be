...
<script>
    var clubickEditApp = new Vue({
        ...
        beforeMount() {
            ...
            this.$http.post(URL_API + "Clubick/GetById.php", fd).then(function(response){
                let responseBody = response.body;
                this.id = responseBody.id;
                this.date = responseBody.date;
                this.customer = responseBody.customer;
                this.product = responseBody.product;
                this.invoice = responseBody.invoice;
                this.trm = responseBody.trm;
                this.usdPrice = responseBody.usdPrice;
                this.uniexpressShippingPrice = responseBody.UniexpressShippingPrice;
                this.salePrice = responseBody.salePrice;
                this.nationalShippingPrice = responseBody.nationalShippingPrice;
                this.partialPayment = responseBody.partialPayment;
                this.paymentMethod = responseBody.paymentMethod;
        ...
        methods: {
            ...
            save() {
                ...
                this.$http.post(URL_API + "Clubick/Update.php", fd).then(function(response) {
                    clubickApp.updateItem(
                        this.id,
                        this.date,
                        this.customer,
                        this.product,

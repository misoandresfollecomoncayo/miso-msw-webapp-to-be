...
class PurchaseAgent {
    ...
    public function __construct($idPurchaseAgent, $date, $TRM, $detail, $realCostPurchaseUSD, $freightSaleUSD, $totalCostUSD, $totalCostCOP, $salePriceCOP, $utilityCOP, $freightUSD, $status, $reference) {
        $this->idPurchaseAgent = $idPurchaseAgent;
        $this->date = $date;
        $this->TRM = $TRM;
        $this->detail = $detail;
    ...
    public function getIdPurchaseAgent() {
        return $this->idPurchaseAgent;
    }

...
$service->setCallback(function() use ($service) {
    BillPartialPaymentDAO::create($service->getParameter("Date")->getValue(), $service->getParameter("Amount")->getValue(), $service->getParameter("IdPaymentMethod")->getValue(), $service->getParameter("IdBill")->getValue(), CloudEngineSession::getSessionObject()->getIdRegister());
